...
/* ------------------------------------------------------------- */
/* Should not be modified */
#define NMT_Start_Node              0x01			/* ÇÐ»»µ½¡°²Ù×÷¡±×´Ì¬ */
#define NMT_Stop_Node               0x02			/* ÇÐ»»µ½¡°Í£Ö¹¡±×´Ì¬ */
#define NMT_Enter_PreOperational    0x80			/* ÇÐ»»µ½¡°Ô¤²Ù×÷¡±×´Ì¬ */
#define NMT_Reset_Node              0x81			/* ÖØÖÃ */
#define NMT_Reset_Comunication      0x82			/* ÖØÖÃÍ¨ÐÅ */
